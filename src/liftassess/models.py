...
class EvidenceAvailabilityTier(str, Enum):
    """Which UCSC evidence families were available to the scientific run."""
...
class EvidenceKind(str, Enum):
    """Evidence categories carried by the current scientific model."""
...
class ReciprocalBestMembershipStatus(str, Enum):
    """Evidence-detail coverage state, not an aggregate result verdict."""
...
class NormalizedCandidate:
    """A normalized candidate mapping produced for result-profile derivation.
