...
liftAssess project research discussions through **2026-09-12**. Sources mentioned only as possible
...
4. Ormond C, Ryan NM, Corvin A, Heron EA. Converting single nucleotide variants between
   genome builds: from cautionary tale to solution. *Brief Bioinform.* 2021;22(5):bbab069.
   doi:10.1093/bib/bbab069. Available from: https://doi.org/10.1093/bib/bbab069

   **Interpretation relevance for liftAssess:** Ormond et al. explicitly evaluates forward
   conversion followed by conversion back to the source build. Positions that do not return to
   the original position are treated as conversion-unstable, and the paper states that a
   one-to-one correspondence between builds does not exist for those positions. The study also
   shows why this matters for downstream annotation and variant analysis. Shumate and Salzberg
   provide complementary evidence that successful coordinate transfer does not by itself preserve
   the biological integrity or identity of genes, transcripts, or other structured features.

5. Jagannathan V, Hitte C, Kidd JM, Masterson P, Murphy TD, Emery S, et al.
...
6. Wang C, Wallerman O, Arendt ML, Sundström E, Karlsson Å, Nordin J, et al.
...
7. UCSC Genome Browser Project. Chain Format [Internet]. Santa Cruz (CA): University of
   California, Santa Cruz; [cited 2026 Aug 17]. Available from:
   https://genome.ucsc.edu/goldenPath/help/chain.html

8. UCSC Genome Browser Project. Net Format [Internet]. Santa Cruz (CA): University of
   California, Santa Cruz; [cited 2026 Aug 17]. Available from:
   https://genome.ucsc.edu/goldenPath/help/net.html

9. UCSC Genome Browser Project. Genome Browser User's Guide [Internet]. Santa Cruz (CA):
...
10. UCSC Genome Browser Project. Genome Browser Licensing [Internet]. Santa Cruz (CA):
   University of California, Santa Cruz; [cited 2026 Aug 17]. Available from:
   https://genome.ucsc.edu/license/

11. UCSC Genome Browser Project. canFam3 liftOver download directory and README/terms
...
12. UCSC Genome Browser Project. canFam3 versus canFam4 comparative alignment directory and
...
13. UCSC Genome Browser Project. canFam3 versus canFam4 provider MD5 metadata
    [Internet]. Santa Cruz (CA): University of California, Santa Cruz;
    [cited 2026 Aug 17]. Available from:
    https://hgdownload.soe.ucsc.edu/goldenPath/canFam3/vsCanFam4/md5sum.txt

14. UCSC Genome Browser Project. canFam4 versus canFam3 reciprocal-best alignment directory
    [Internet]. Santa Cruz (CA): University of California, Santa Cruz;
    [cited 2026 Aug 17]. Available from:
    https://hgdownload.soe.ucsc.edu/goldenPath/canFam4/vsCanFam3/reciprocalBest/

15. UCSC Genome Browser Project. canFam4 versus canFam3 reciprocal-best provider MD5 metadata
    [Internet]. Santa Cruz (CA): University of California, Santa Cruz;
    [cited 2026 Aug 17]. Available from:
    https://hgdownload.soe.ucsc.edu/goldenPath/canFam4/vsCanFam3/reciprocalBest/md5sum.txt

16. UCSC Genome Browser Project. canFam6 liftOver download directory [Internet].
...
17. UCSC Genome Browser Project. kent source tree license [Internet]. GitHub;
    [cited 2026 Aug 17]. Available from:
    https://github.com/ucscGenomeBrowser/kent/blob/master/LICENSE

18. UCSC Genome Browser Project. doBlastzChainNet.pl [source code on Internet]. GitHub;
    [cited 2026 Aug 17]. Available from:
    https://raw.githubusercontent.com/ucscGenomeBrowser/kent/refs/heads/master/src/hg/utils/automation/doBlastzChainNet.pl

19. UCSC Genome Browser Project. doRecipBest.pl [source code on Internet]. GitHub;
    [cited 2026 Aug 17]. Available from:
    https://raw.githubusercontent.com/ucscGenomeBrowser/kent/refs/heads/master/src/hg/utils/automation/doRecipBest.pl

20. UCSC Genome Browser Project. Genome Browser Data Downloads [Internet]. Santa Cruz (CA):
    University of California, Santa Cruz; [cited 2026 Aug 17]. Available from:
    https://genome.ucsc.edu/goldenPath/help/ftp.html

21. Fielding R, Nottingham M, Reschke J. HTTP Semantics. RFC 9110 [Internet].
    Internet Engineering Task Force; 2022 Jun [cited 2026 Aug 17].
    Available from: https://www.rfc-editor.org/rfc/rfc9110

22. National Center for Biotechnology Information. Genome sequence report
...
23. National Center for Biotechnology Information. Create a table from the genome data reports:
...
24. Global Alliance for Genomics and Health. Refget Sequences v2.0.0
    [Internet]. GA4GH; [cited 2026 Aug 17]. Available from:
    https://ga4gh.github.io/refget/sequences/

25. Global Alliance for Genomics and Health. Refget Sequence Collections v1.0.0
    [Internet]. GA4GH; [cited 2026 Aug 17]. Available from:
    https://ga4gh.github.io/refget/seqcols/

26. UCSC Genome Browser Project. chromInfo table schema [source code on Internet].
...
27. UCSC Genome Browser Project. chromAlias table schema [source code on Internet].
    Santa Cruz (CA): University of California, Santa Cruz; [cited 2026 Aug 28].
    Available from:
    https://raw.githubusercontent.com/ucscGenomeBrowser/kent/master/src/hg/lib/chromAlias.sql

28. UCSC Genome Browser Project. hg38 assembly download README [Internet].
    Santa Cruz (CA): University of California, Santa Cruz; [cited 2026 Aug 28].
    Available from:
    https://hgdownload.soe.ucsc.edu/goldenPath/hg38/bigZips/README.txt

29. UCSC Genome Browser Project. canFam3 genome annotation database download directory
    [Internet]. Santa Cruz (CA): University of California, Santa Cruz;
    [cited 2026 Aug 28]. Available from:
    https://hgdownload.soe.ucsc.edu/goldenPath/canFam3/database/

30. UCSC Genome Browser Project. canFam4 genome annotation database download directory
    [Internet]. Santa Cruz (CA): University of California, Santa Cruz;
    [cited 2026 Aug 28]. Available from:
    https://hgdownload.soe.ucsc.edu/goldenPath/canFam4/database/

31. UCSC Genome Browser Project. hg38 assembly description [Internet].
    Santa Cruz (CA): University of California, Santa Cruz; [cited 2026 Aug 28].
    Available from:
    https://hgdownload.soe.ucsc.edu/gbdb/hg38/html/description.html


32. National Center for Biotechnology Information. `datasets download genome`
    [Internet]. Bethesda (MD): National Library of Medicine (US);
    [cited 2026 Aug 28]. Available from:
    https://www.ncbi.nlm.nih.gov/datasets/docs/v2/reference-docs/command-line/datasets/download/genome/

33. National Center for Biotechnology Information. NCBI genome data package
    [Internet]. Bethesda (MD): National Library of Medicine (US);
    [cited 2026 Aug 28]. Available from:
    https://www.ncbi.nlm.nih.gov/datasets/docs/v2/reference-docs/file-formats/data-package/

34. National Center for Biotechnology Information. NCBI Datasets v2 REST API
    [Internet]. Bethesda (MD): National Library of Medicine (US);
    [cited 2026 Aug 28]. Available from:
    https://www.ncbi.nlm.nih.gov/datasets/docs/v2/api/rest-api/

35. UCSC Genome Browser Project. Segmental Dups track description, GRCh38/hg38
    [Internet]. Santa Cruz (CA): University of California, Santa Cruz;
    [cited 2026 Aug 28]. Available from:
    https://genome.ucsc.edu/cgi-bin/hgTrackUi?db=hg38&g=genomicSuperDups

36. UCSC Genome Browser Project. `genomicSuperDups` table schema, GRCh38/hg38
    [Internet]. Santa Cruz (CA): University of California, Santa Cruz;
    [cited 2026 Aug 28]. Available from:
...
37. UCSC Genome Browser Project. Segmental Dups track description, GRCh37/hg19
    [Internet]. Santa Cruz (CA): University of California, Santa Cruz;
    [cited 2026 Aug 28]. Available from:
    https://genome.ucsc.edu/cgi-bin/hgTrackUi?db=hg19&g=genomicSuperDups

38. UCSC Genome Browser Project. `genomicSuperDups` table schema, GRCh37/hg19
    [Internet]. Santa Cruz (CA): University of California, Santa Cruz;
    [cited 2026 Aug 28]. Available from:
...
39. UCSC Genome Browser Project. hg38 genome annotation database download directory
    [Internet]. Santa Cruz (CA): University of California, Santa Cruz;
    [cited 2026 Aug 28]. Available from:
    https://hgdownload.soe.ucsc.edu/goldenPath/hg38/database/

40. UCSC Genome Browser Project. hg19 genome annotation database download directory
    [Internet]. Santa Cruz (CA): University of California, Santa Cruz;
    [cited 2026 Aug 28]. Available from:
    https://hgdownload.soe.ucsc.edu/goldenPath/hg19/database/

41. UCSC Genome Browser Project. hg19 assembly description [Internet].
...
42. UCSC Genome Browser Project. hg19 assembly download README [Internet].
    Santa Cruz (CA): University of California, Santa Cruz; [cited 2026 Aug 29].
    Available from:
    https://hgdownload.soe.ucsc.edu/goldenPath/hg19/bigZips/README.txt

43. UCSC Genome Browser Project. hg38 self-chain download directory and README/terms
    [Internet]. Santa Cruz (CA): University of California, Santa Cruz;
    [cited 2026 Sep 25]. Available from:
    https://hgdownload.soe.ucsc.edu/goldenPath/hg38/vsSelf/

44. UCSC Genome Browser Project. hg38 self-chain provider MD5 metadata [Internet].
    Santa Cruz (CA): University of California, Santa Cruz; [cited 2026 Sep 25].
    Available from:
    https://hgdownload.soe.ucsc.edu/goldenPath/hg38/vsSelf/md5sum.txt

45. UCSC Genome Browser Project. Self Chain track description, GRCh38/hg38 [Internet].
    Santa Cruz (CA): University of California, Santa Cruz; [cited 2026 Sep 25].
    Available from:
    https://genome.ucsc.edu/cgi-bin/hgTrackUi?db=hg38&g=chainSelf
...
46. Biostars. Which locus should be considered the true ortholog after liftOver disagreement
    between chrUn and chr16 in canFam4 miRNA mapping? [Internet].
    [cited 2026 Aug 17]. Available from:
    https://www.biostars.org/p/9619818/

47. Biostars. UCSC liftover [Internet]. 2021 Jul 15 [cited 2026 Aug 17].
    Available from: https://www.biostars.org/p/9480565/

48. Bioconductor Support. Bug in rtracklayer liftOver function [Internet].
    [cited 2026 Aug 17]. Available from:
    https://support.bioconductor.org/p/9136646/

49. Bioconductor Support. rtracklayer::lifOver one-to-many regions and not match UCSC
    [Internet]. [cited 2026 Aug 17]. Available from:
    https://support.bioconductor.org/p/99306/

50. hbc/giab_remap_38. Crossmap liftover issues. Issue #1 [Internet]. GitHub;
